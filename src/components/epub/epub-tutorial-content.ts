...
export const EPUB_TUTORIAL_CONTENT_BY_LANG: Record<TutorialLanguage, TutorialContentByTab> = {
	...
	// The public repository does not ship generated ja-JP/ko-KR tutorial JSON.
	// Keep those locales buildable and usable by falling back to English content;
	// their tab labels above remain localized.
